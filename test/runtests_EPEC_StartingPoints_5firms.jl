...
Profits_Objective_Function=zeros(Number_Runs,5)
...
share_starting_4_renew=0.1
share_starting_4_thermal=0.1

start_point=1

@time (profit_det_MPEC_val_firm1,profit_det_MPEC_val_firm2,profit_det_MPEC_val_firm3,profit_det_MPEC_val_firm4,profit_det_MPEC_val_firm5,x_w_p,x_e_p,Total_Investments_Technology_EPEC_par,Total_Investments_Technology_Firms_EPEC_par,Total_Investments_Technology_Firm1_EPEC_par_iter,Total_Investments_Technology_Firm2_EPEC_par_iter,Total_Investments_Technology_Firm1_EPEC_par_iter_diff,Total_Investments_Technology_Firm2_EPEC_par_iter_diff,Total_Investments_Technology_Firms_EPEC_par_iter_diff,Nash_Equilibrium_Indicator_bin,Total_Revenue_Cost_demandblock_EPEC_res)=Solver_EPEC_Diag_StartingPoints_5firms(share_starting_1_renew,share_starting_1_thermal,share_starting_2_renew,share_starting_2_thermal,share_starting_3_renew,share_starting_3_thermal,share_starting_4_renew,share_starting_4_thermal,start_point,scenario,scenario_tax,scenario_ownership,Trans_Cap,Gurobi.Optimizer,"results/EPEC_Solution.txt","results_startingpoints/$scenario/$start_point")
...
Profits_Objective_Function[start_point,5]=profit_det_MPEC_val_firm5
...
share_starting_2_thermal=0.5
share_starting_3_renew=0.1
share_starting_3_thermal=0.1
share_starting_4_renew=0.6
share_starting_4_thermal=0.2
...
share_starting_4_renew=0.8
share_starting_4_thermal=0.8
...
share_starting_3_renew=0.1
share_starting_3_thermal=0.1
share_starting_4_renew=0.3
share_starting_4_thermal=0.3
...
share_starting_1_thermal=0.05
share_starting_2_renew=0.4
share_starting_2_thermal=0.1
share_starting_3_renew=0.7
share_starting_3_thermal=0.8
share_starting_4_renew=0.3
share_starting_4_thermal=0.15
...
share_starting_4_renew=0.65
share_starting_4_thermal=0.35
...
share_starting_3_thermal=1
share_starting_4_renew=0
share_starting_4_thermal=0
...
share_starting_1_thermal=0.1
share_starting_2_renew=0.2
share_starting_2_thermal=0.65
share_starting_3_renew=0.5
share_starting_3_thermal=0.15
share_starting_4_renew=0.1
share_starting_4_thermal=0.1
