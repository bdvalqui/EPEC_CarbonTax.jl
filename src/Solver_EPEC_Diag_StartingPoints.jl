function Solver_EPEC_Diag_StartingPoints(share_starting_1_renew,share_starting_1_thermal,start_point,scenario,scenario_tax,scenario_ownership,Trans_Cap,optimizer::Type{<:AbstractOptimizer},resultfile::String="",folder::String="")
