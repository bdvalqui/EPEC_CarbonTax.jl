function Solver_EPEC_Reaction(x_w_p,x_e_p,start_point,Leader,Follower,set_thermalgenerators_options_par,set_wind_options_par,optimizer::Type{<:AbstractOptimizer},resultfile::String="",folder::String="")
...
for w in set_wind_options if wind_ownership_options[w]==Follower
#global x_w_p[w]=x_w_value_MPEC[w]
global x_w_p_iter[w,iter]=x_w_p[w]
end
end

for e in set_thermalgenerators_options if thermal_ownership_options[e]==Follower
#global x_e_p[e]=x_e_value_MPEC[e]
global x_e_p_iter[e,iter]=x_e_p[e]
end
end
