function Plots_CapacityMix_4firms(Total_Investments_Technology_CP,Total_Investments_Technology_EPEC_par,Total_Investments_Technology_Firm1_EPEC_par,Total_Investments_Technology_Firm2_EPEC_par,Total_Investments_Technology_Firm3_EPEC_par,Τ)
...
#Change
##########
sizes = [Total_Investments_Technology_Firm3_EPEC[3],Total_Investments_Technology_Firm3_EPEC[6],Total_Investments_Technology_Firm3_EPEC[7]]
font = Dict("fontname"=>"Sans","weight"=>"semibold","color"=>"black","size"=>10)
...
#PyPlot.title("Beer")
savefig("results/Results_PieChart_Firm3_EPEC$Τ.png",dpi=300, bbox_inches="tight")
close()
