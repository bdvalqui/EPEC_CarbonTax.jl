function Solver_EPEC_Diag_StartingPoints_3firms(share_starting_1_renew,share_starting_1_thermal,share_starting_2_renew,share_starting_2_thermal,start_point,scenario,scenario_tax,scenario_ownership,Trans_Cap,optimizer::Type{<:AbstractOptimizer},resultfile::String="",folder::String="")
...
global Total_Investments_Technology_Firms_EPEC_par_iter_diff=sum(vcat(Total_Investments_Technology_Firm1_EPEC_par_iter_diff, Total_Investments_Technology_Firm2_EPEC_par_iter_diff, Total_Investments_Technology_Firm3_EPEC_par_iter_diff),dims=1)
...
Total_Investments_Technology_Firms_EPEC_par=[Total_Investments_Technology_Firm1_EPEC_par,Total_Investments_Technology_Firm2_EPEC_par,Total_Investments_Technology_Firm3_EPEC_par]
