function Solver_EPEC_Diag_StartingPoints_Nfirms(Number_Firms,start_point,scenario,scenario_tax,scenario_ownership,Trans_Cap,optimizer::Type{<:AbstractOptimizer},resultfile::String="",folder::String="")

global iterations=1:5
global Nash_Equilibrium_Indicator=1000
global Total_Investments_Technology_Firms_EPEC_par_iter=zeros(7,length(iterations),Number_Firms)
global Total_Investments_Technology_Firms_EPEC_par=zeros(7,Number_Firms)

global Total_Investments_Technology_Firms_EPEC_par_iter_dummy1=zeros(7,length(iterations)-1,Number_Firms)
global Total_Investments_Technology_Firms_EPEC_par_iter_dummy2=zeros(7,length(iterations)-1,Number_Firms)
