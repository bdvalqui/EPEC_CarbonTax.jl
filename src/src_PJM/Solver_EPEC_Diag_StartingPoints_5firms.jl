function Solver_EPEC_Diag_StartingPoints_5firms(share_starting_1_renew,share_starting_1_thermal,share_starting_2_renew,share_starting_2_thermal,share_starting_3_renew,share_starting_3_thermal,share_starting_4_renew,share_starting_4_thermal,start_point,scenario,scenario_tax,scenario_ownership,Trans_Cap,optimizer::Type{<:AbstractOptimizer},resultfile::String="",folder::String="")
...
global Total_Investments_Technology_Firm5_EPEC_par_iter=zeros(7,length(iterations))
...
global profit_det_MPEC_val_firm5=profit_det_MPEC
...
global revenue_cost_EPEC=zeros(12)
...
global revenue_cost_EPEC[11]=Totalrevenue_MPEC_Firm6
global revenue_cost_EPEC[12]=TotalOperatingCost_MPEC_Firm6
...
global df_Total_Investments_Technology_Firm5_EPEC=DataFrame(Total_Investments_Technology_Firm5_EPEC',:auto)

global Total_Revenue_Cost_demandblock_EPEC=zeros(length(set_times),12)
...
global Total_Revenue_Cost_demandblock_EPEC[t,11]=Totalrevenue_demandblock_MPEC_Firm6[t]
global Total_Revenue_Cost_demandblock_EPEC[t,12]=TotalOperatingCost_demandblock_MPEC_Firm6[t]
end
...
global Total_Investments_Technology_Firm5_EPEC_par=Total_Investments_Technology_Firm5_EPEC
...
global Total_Investments_Technology_Firm5_EPEC_par_iter[:,iter]=Total_Investments_Technology_Firm5_EPEC
...
Total_Investments_Technology_Firm5_EPEC_par_iter_dummy1=view(Total_Investments_Technology_Firm5_EPEC_par_iter, :, 2:iter)
Total_Investments_Technology_Firm5_EPEC_par_iter_dummy2=view(Total_Investments_Technology_Firm5_EPEC_par_iter, :, 1:iter-1)
...
global Total_Investments_Technology_Firm5_EPEC_par_iter_diff=sum(abs.(Total_Investments_Technology_Firm5_EPEC_par_iter_dummy1-Total_Investments_Technology_Firm5_EPEC_par_iter_dummy2),dims=1)


global Total_Investments_Technology_Firms_EPEC_par_iter_diff=sum(vcat(Total_Investments_Technology_Firm1_EPEC_par_iter_diff,Total_Investments_Technology_Firm2_EPEC_par_iter_diff,Total_Investments_Technology_Firm3_EPEC_par_iter_diff,Total_Investments_Technology_Firm4_EPEC_par_iter_diff,Total_Investments_Technology_Firm5_EPEC_par_iter_diff),dims=1)
...
Total_Investments_Technology_Firms_EPEC_par=[Total_Investments_Technology_Firm1_EPEC_par,Total_Investments_Technology_Firm2_EPEC_par,Total_Investments_Technology_Firm3_EPEC_par,Total_Investments_Technology_Firm4_EPEC_par,Total_Investments_Technology_Firm5_EPEC_par]
...
CSV.write(folder *"/Results_Total_Investments_Firm5_EPEC$Τ.csv", df_Total_Investments_Technology_Firm5_EPEC)
...
for t in set_times
global Total_Revenue_Cost_demandblock_EPEC_Plot[t,1]=(Total_Revenue_Cost_demandblock_EPEC[t,1]+Total_Revenue_Cost_demandblock_EPEC[t,3]+Total_Revenue_Cost_demandblock_EPEC[t,5]+Total_Revenue_Cost_demandblock_EPEC[t,7]+Total_Revenue_Cost_demandblock_EPEC[t,9]+Total_Revenue_Cost_demandblock_EPEC[t,11])./(10^6)
global Total_Revenue_Cost_demandblock_EPEC_Plot[t,2]=(Total_Revenue_Cost_demandblock_EPEC[t,2]+Total_Revenue_Cost_demandblock_EPEC[t,4]+Total_Revenue_Cost_demandblock_EPEC[t,6]+Total_Revenue_Cost_demandblock_EPEC[t,8]+Total_Revenue_Cost_demandblock_EPEC[t,10]+Total_Revenue_Cost_demandblock_EPEC[t,12])./(10^6)
end
