...
include("Investment_OPF_original_PJM.jl")
include("OPF_original.jl")
include("OPF_original_PJM.jl")
...
include("Investment_OPF_MPEC_Nfirms.jl")
include("Investment_OPF_MPEC_Nfirms_PJM.jl")
...
include("Solver_EPEC_Diag_StartingPoints_Nfirms.jl")
include("Solver_EPEC_Diag_StartingPoints_Nfirms_PJM.jl")
...
include("loadinputs_startingpoints_Nfirms.jl")
include("loadinputs_startingpoints_Nfirms_PJM.jl")
