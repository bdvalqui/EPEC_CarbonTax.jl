function Solver_MPEC_PJM(optimizer::Type{<:AbstractOptimizer},resultfile::String="")
...
(syscost_det,x_w_value,x_e_value,set_opt_winds_numbertechnologies,set_opt_thermalgenerators_numbertechnologies,Total_Investments_Technology_CP)=Solver_CentralPlanner_scenario_PJM(optimizer,"results/CentralPlanner_Solution.txt")
