...
Total_Generation_Technology_CP=zeros(Number_of_technologies_thermal_renewables,length(set_times))
Total_Generation_Technology_Existing_CP=zeros(Number_of_technologies_thermal_renewables,length(set_times))
Total_Generation_Technology_Candidate_CP=zeros(Number_of_technologies_thermal_renewables,length(set_times))

Total_Emissions_Technology_CP=zeros(Number_of_technologies_thermal_renewables,length(set_times))
Total_Emissions_Technology_Existing_CP=zeros(Number_of_technologies_thermal_renewables,length(set_times))
Total_Emissions_Technology_Candidate_CP=zeros(Number_of_technologies_thermal_renewables,length(set_times))

Total_Emissions_Technology_Existing_Cummulative_CP=zeros(Number_of_technologies_thermal_renewables)
Total_Emissions_Technology_Candidate_Cummulative_CP=zeros(Number_of_technologies_thermal_renewables)
...
Total_Emissions_Technology_Candidate_Cummulative_CP[i]=sum(sum(tech_thermal_opt[e,EmissionsRate]*tech_thermal_opt[e,HeatRate]*p_G_e_opt_value[e,t,1] for e in set_opt_thermalgenerators if tech_thermal_opt[e,Technology]==i;init=0)*Ns_H[t] for t in set_times)
...
Total_Emissions_Technology_Existing_Cummulative_CP[i]=sum(sum(tech_thermal[e,EmissionsRate]*tech_thermal[e,HeatRate]*p_G_e_value[e,t,1] for e in set_thermalgenerators if tech_thermal[e,Technology]==i;init=0)*Ns_H[t] for t in set_times)
...
#Thermal Generation
p_G_e_value_CP=zeros(22,length(set_times),length(set_scenarios))
p_G_e_value_node1_CP=zeros(22,length(set_times),length(set_scenarios))
p_G_e_value_node2_CP=zeros(22,length(set_times),length(set_scenarios))
p_G_e_value_node3_CP=zeros(22,length(set_times),length(set_scenarios))
p_G_w_value_node1_CP=zeros(10,length(set_times),length(set_scenarios))
p_G_w_value_node2_CP=zeros(10,length(set_times),length(set_scenarios))
p_G_w_value_node3_CP=zeros(10,length(set_times),length(set_scenarios))
υ_SR_value_CP=zeros(22,length(set_times),length(set_scenarios))

for t in set_times, s in set_scenarios, e in 1:12
...
#Wind Generation
p_G_w_value_CP=zeros(10,length(set_times),length(set_scenarios))

for t in set_times, s in set_scenarios, w in 1:6
...
#================================#
Total_Generation_Technology_node1_CP=zeros(12,length(set_times))
...
#================================#
Total_Generation_Technology_node2_CP=zeros(12,length(set_times))
...
#===================================#
Total_Generation_Technology_node3_CP=zeros(12,length(set_times))
